...
::: {#me}
Hi I'm Luke, a current double major in statistics and math at Rutgers and soon to be master student in financial statistics. My academic interests are probability theory, stochastic processes, and Monte Carlo simulations. My career goal is to become a quantitative research (statistical arbitrage) and I am currently looking for quantitative research experience to supplement my education. My current goals are learning more about the financial markets and becoming proficient in self-learning/reading math textbooks. Some of my hobbies include playing video games, taekwondo, volleyball, and learning K-Pop dances.
